...
document.addEventListener('DOMContentLoaded', () => {
  const analyzeButton = document.getElementById('analyzeWithAI') as HTMLButtonElement;
  const contextInfo = document.getElementById('contextInfo') as HTMLTextAreaElement;
  ...
  const setAnalyzeButtonState = (enabled: boolean) => {
